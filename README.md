...
[![GitHub Actions](https://github.com/tnir/mysqlclient/workflows/Docker%20Image%20CI/badge.svg?branch=master)](https://github.com/tnir/mysqlclient/actions?query=branch%3Amaster)

powered by [![PyPI version](https://badge.fury.io/py/mysqlclient.svg)](https://badge.fury.io/py/mysqlclient)

the mysqlclient Docker image (based on python:3.8.5-alpine3.12)
